<div class="col-md-12">
    <div class="card mb-4">
        <div class="card-body">
            <div class="card-title mb-3">{{ __('Création role')}}</div>
            <form>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-primary btn-rounded mr-3" wire:click.prevent="SaveRole()" wire:loading.attr="disabled" wire:target="saveType()">
                            <span wire:loading.remove wire:target="SaveRole"><i class="nav-icon i-Yes font-weight-bold"></i> Enregistrer</span>

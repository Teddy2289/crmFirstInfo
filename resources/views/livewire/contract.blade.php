                                ...
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="company_id"
                                                           class="form-label">{{__('Companie')}}</label>
                                        ...
                                        <div class="row col-md-12">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="user_id" class="form-label">{{__('Utilisateur')}}<span
                                                            class="text-danger">(*)</span></label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="daily_rate" class="form-label">{{__('Daily Rate')}}<span
                                                            class="text-danger">(*)</span></label>
                                                    <input type="text" class="form-control" id="daily_rate"
                                                           name="daily_rate" wire:model.lazy="daily_rate">
                                                    @error('daily_rate')
                                                    <div class="alert alert-danger" role="alert">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 mt-3 mb-3">
                                            <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                                                <span wire:loading wire:target="storeContract"
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="edit_client_id"
                                                           class="form-label">{{__('Client')}}</label>
                                                    <select class="form-control" id="edit_client_id"
                                                            name="edit_client_id" wire:model.lazy="client_id">
                                        ...
                                        <div class="row col-md-12">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" id="edit_user_id" name="edit_user_id"
                                                            wire:model.lazy="user_id">
                                                        <option value="">{{__('sélectionner utilisateur')}}</option>
                                                        @foreach($users as $user)
                                                            <option value="{{ $user->id }}">{{ $user->name }}</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="edit_daily_rate"
                                                           class="form-label">{{__('Daily Rate')}}</label>
                                                    <input type="text" class="form-control" id="edit_daily_rate"
                                                           name="edit_daily_rate" wire:model.lazy="daily_rate">
                                                    @error('daily_rate')
                                                    <div class="alert alert-danger" role="alert">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 mt-3 mb-3">
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                ...
                                                <span wire:loading wire:target="updateContractConfirmed"
                                                      class="spinner-border spinner-border-sm" role="status"
                                                      aria-hidden="true"></span>
                                                {{__('Enregister')}}</button>
                                            <button type="button" class="btn btn-danger"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary"
                                                        wire:click="updateContractConfirmed">{{__('Confirmer')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div wire:ignore.self class="modal fade" id="deleteConfirmationModal" tabindex="-1"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"
                                            id="deleteConfirmationModalLabel">{{__('Confirmation')}}</h5>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal"> {{__('Annuler')}}</button>
                                        <button type="button" class="btn btn-danger"
                                                wire:click="deleteContractConfirmed">{{__('Supprimer')}}</button>
                                    </div>
                                </div>
                            </div>
                        </div>

    ...
    <body>
            ...
            <tbody>
                <tr>
                    <td class="px-0">
                        ...
                        @if($invoice->seller->custom_address)
                            <p class="seller-address">
                                {{ $invoice->seller->custom_address }}
                            </p>
                        @endif
                    ...
                    <td class="px-0">
                        ...
                        @if($invoice->buyer->custom_address)
                            <p class="buyer-address">
                                {{ $invoice->buyer->custom_address }}
                            </p>
                        @endif
        ...
        <table class="table table-items">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="{{ $invoice->table_columns - 3 }}" class="border-0"></td>
                    <td class="text-right pl-0">{{ __('invoices::invoice.total_to_pay') }}</td>
                ...
                <tr>
                    <td colspan="{{ $invoice->table_columns - 3 }}" class="border-0"></td>
                    <td class="text-right pr-0 total-amount" colspan="2">
        ...
        <p>
            <b>Modes de règlement : Virement</b><br><br>
            <span>- IBAN :  {{ $invoice->seller->iban }}  | BIC/SWIFT: {{ $invoice->seller->bic }}</span><br>
            <span>- Banque: 18206 | Guichet: 00241 | Compte: 65080154709 | Clé 28</span>
        </p>
        ...
        @endif
        <p>
            <b>{{ trans('invoices::invoice.pay_until') }}</b>: @if($invoice->pay_until_days){{ $invoice->getPayUntilDate() }} @else {{ trans('invoices::invoice.no_pay_until') }} @endif
        </p>
